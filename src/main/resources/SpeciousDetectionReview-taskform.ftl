...
<div id="container">
	<div id="header">
		User Task Form: CapabilitiesRequirementValidation.SpeciousDetectionReview
	</div>
	<div id="content">
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<div class="div_checkbox">
                              		<input name="fileOkToReview" type="checkbox" class="checkbox" id="fileOkToReview" value="${fileOkToReview}" />
                            		</div>
